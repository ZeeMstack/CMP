...
def get_ledger(
    ...
    return [
        GradedProduceLotLedgerEntryRead(
            ...
            packing_event_id=e.packing_event_id, grading_reversal_event_id=e.grading_reversal_event_id,
            packing_reversal_event_id=e.packing_reversal_event_id, actor_user_id=e.actor_user_id,
