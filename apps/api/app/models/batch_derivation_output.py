...
class BatchDerivationOutput(Base):
    """Immutable, insert-only record of one output batch created by a split
    or merge (CMP-012). No `output_batch_code` column here — the code is
    immutable on `crop_batches.code`, the single source of truth."""

    __tablename__ = "batch_derivation_outputs"
    ...
    __table_args__ = (
        ...
        UniqueConstraint("output_batch_id", name="ux_batch_derivation_outputs_output_batch"),
