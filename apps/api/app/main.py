...
from app.api.equipment_attention import router as equipment_attention_router
from app.api.equipment_incidents import router as equipment_incidents_router
from app.api.equipment_readiness import router as equipment_readiness_router
...
from app.api.vines_production_disposition import router as vines_production_disposition_router
...
from app.api.inventory_material_events import router as inventory_material_events_router
...
def create_app(cfg: Settings) -> FastAPI:
    ...
    api.include_router(inventory_item_packaging_router)
    api.include_router(inventory_item_seed_profiles_router)
    api.include_router(goods_receipts_router)
    ...
    api.include_router(inventory_material_events_router)
    ...
    api.include_router(vines_production_disposition_router)
    ...
    api.include_router(equipment_readiness_router)
    api.include_router(equipment_incidents_router)
    api.include_router(equipment_attention_router)
