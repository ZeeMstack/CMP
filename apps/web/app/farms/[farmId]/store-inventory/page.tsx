...
import { useFarm, useGoodsReceipts, useQualityWorkQueue } from "@/lib/query/hooks";
...
/** STORE-INV-002A.2: an operational summary, never a global readiness
 * claim -- no invented readiness score, no "available to issue", no
 * current Store/Bin location (docs/build-plans/
 * STORE_INV_002A2_QUALITY_OPERATIONAL_UX_BUILD_PLAN.md). Custody does not
 * exist until STORE-INV-002B, so this page never implies it. */
