...
/** UX-IA-001: the Categories manager within the Store & Inventory Setup
 * workspace's Settings view -- extracted, unchanged in substance, from the
 * pre-existing `/inventory-categories` page. Rendered by both that legacy
 * route and the new workspace `settings` child route. */
