...
Carrier release/reassignment, transplanting, transformations, split/merge, automatic stage progression, automatic pass/fail rules, scoring/formula engines, approval workflows, role-specific hold authority, correction/void of observations or holds, seed inventory deduction, laboratory integrations, sensors/IoT ingestion, occupancy/movement changes, harvest, packing, QR identities, labels, frontend, RLS.
