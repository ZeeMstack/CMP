...
| UNKNOWN | Legacy/newly-registered readiness state — truthfully "not yet assessed", never fabricated READY; excluded from "available" reads exactly like AWAITING_CLEANING/DAMAGED/MAINTENANCE/RETIRED (UNKNOWN != READY has no exception) |
